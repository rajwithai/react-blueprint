            ...
            `}>
                  ...
                  `}>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-3">
                                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex items-center gap-3 text-sm font-medium text-navy">
                                    <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                                    Private models
                                    <span className="text-xs text-slate-400 ml-auto">(where applicable)</span>
                                </div>

                                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex items-center gap-3 text-sm font-medium text-navy group relative overflow-hidden">
                                    <div className="absolute inset-0 bg-slate-50/50 group-hover:bg-transparent transition-colors"></div>
